...
with tab4:
    ...
    with center:
        st.image("https://www.tucsonaz.gov/files/sharedassets/public/v/1/police/documents/maps/tpd-divisions.png?dimension=pageimage&w=480",
            caption = "Tucson Police Department Divisions", use_container_width = True)
...
with tab5:
    ...
    with center2:
        st.image("https://www.arcgis.com/sharing/rest/content/items/9745a38738ab4ca5b85dfd38086bb1b0/resources/wards.jpg?v=1778198400081&w=400",
            caption = "Tucson City Council Wards", use_container_width = True)
...
st.divider()
st.caption("Data source: Tucson Police Department Open Data Portal — https://policeanalysis.tucsonaz.gov/pages/reported-crimes")